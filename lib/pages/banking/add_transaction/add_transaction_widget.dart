                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    future: NawiriPOSGroup.getBankTransTypesCall
                                        .call(),
                                    builder: (context, snapshot) {
                                      ...
                                      final ddBankingtypeGetBankTransTypesResponse =
                                          snapshot.data!;
                                      return FlutterFlowDropDown<String>(
                                        controller: _model
                                                .ddBankingtypeValueController ??=
                                            FormFieldController<String>(
                                          _model.ddBankingtypeValue ??= '',
                                        ),
                                        options: List<String>.from(
                                            NawiriPOSGroup.getBankTransTypesCall
                                                .typeID(
                                          ddBankingtypeGetBankTransTypesResponse
                                              .jsonBody,
                                        )!),
                                        optionLabels: NawiriPOSGroup
                                            .getBankTransTypesCall
                                            .transType(
                                          ddBankingtypeGetBankTransTypesResponse
                                              .jsonBody,
                                        )!,
