...
import 'customer_receipt_model.dart';
export 'customer_receipt_model.dart';

class CustomerReceiptWidget extends StatefulWidget {
  ...
  @override
  State<CustomerReceiptWidget> createState() => _CustomerReceiptWidgetState();
}

class _CustomerReceiptWidgetState extends State<CustomerReceiptWidget> {
  late CustomerReceiptModel _model;
