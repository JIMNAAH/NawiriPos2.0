...
import 'supplier_pay_widget.dart' show SupplierPayWidget;
import 'package:flutter/material.dart';

class SupplierPayModel extends FlutterFlowModel<SupplierPayWidget> {
  ...
  // Stores action output result for [Backend Call - API (SupplierTrans)] action in Button widget.
