...
import 'supplier_pay_model.dart';
export 'supplier_pay_model.dart';

class SupplierPayWidget extends StatefulWidget {
  const SupplierPayWidget({
    super.key,
  ...
  @override
  State<SupplierPayWidget> createState() => _SupplierPayWidgetState();
}

class _SupplierPayWidgetState extends State<SupplierPayWidget> {
  late SupplierPayModel _model;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                        _model.ddBankingtypeValueController ??=
                                            FormFieldController<String>(
                                      _model.ddBankingtypeValue ??=
                                          'Supplier Payment',
                                    ),
                                    options: const ['Supplier Payment'],
                                    onChanged: (val) => setState(
                                        () => _model.ddBankingtypeValue = val),
                                    width: 320.0,
                                    height: 50.0,
                                    searchHintTextStyle:
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final banksNwGetBanksResponse =
                                          snapshot.data!;
                                      return FlutterFlowDropDown<String>(
                                        controller: _model
                                                .banksValueController ??=
                                            FormFieldController<String>(null),
                                        options: List<String>.from(
                                            NawiriPOSGroup.nwGetBanksCall
                                                .bankId(
                                          banksNwGetBanksResponse.jsonBody,
                                        )!),
