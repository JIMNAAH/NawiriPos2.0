...
import 'supplier_trans_model.dart';
export 'supplier_trans_model.dart';

class SupplierTransWidget extends StatefulWidget {
  const SupplierTransWidget({
    super.key,
  ...
  @override
  State<SupplierTransWidget> createState() => _SupplierTransWidgetState();
}

class _SupplierTransWidgetState extends State<SupplierTransWidget> {
  late SupplierTransModel _model;
                        ...
                        Align(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            future: (_model.apiRequestCompleter ??= Completer<
                                    ApiCallResponse>()
                                  ..complete(
                                      NawiriPOSGroup.getSuppliertransCall.call(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final listViewGetSuppliertransResponse =
                                  snapshot.data!;
                              return Builder(
                                builder: (context) {
                                  final supplierTrans =
                                      listViewGetSuppliertransResponse.jsonBody
                                          .toList();
                                  return RefreshIndicator(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemCount: supplierTrans.length,
                                      itemBuilder:
                                          (context, supplierTransIndex) {
                                        final supplierTransItem =
                                            supplierTrans[supplierTransIndex];
                                        return Padding(
                                          padding:
