          ...
          child: Stack(
            children: [
                              ...
                              child: GridView(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      _model.apiResultht1 = await NawiriPOSGroup
                                          .nwGetBanksCall
                                          .call();
                                      if ((_model.apiResultht1?.succeeded ??
                                          true)) {
                                  ...
                                  FutureBuilder<List<GetCartRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final cardGetCartRowList = snapshot.data!;
                                      return InkWell(
                                        splashColor: Colors.transparent,
                                        focusColor: Colors.transparent,
                                        hoverColor: Colors.transparent,
                                  ...
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('CustomerReport');
                                    },
                                    child: Card(
                                      clipBehavior: Clip.antiAliasWithSaveLayer,
                                      color: const Color(0xFF054D3B),
              ...
              Align(
                ...
                child: wrapWithModel(
                  model: _model.reportNavBarModel,
                  updateCallback: () => setState(() {}),
                  child: const ReportNavBarWidget(),
                ),
              ),
            ],
          ),
