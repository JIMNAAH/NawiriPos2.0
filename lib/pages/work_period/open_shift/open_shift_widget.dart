...
import 'open_shift_model.dart';
export 'open_shift_model.dart';

class OpenShiftWidget extends StatefulWidget {
  const OpenShiftWidget({super.key});

  @override
  State<OpenShiftWidget> createState() => _OpenShiftWidgetState();
}

class _OpenShiftWidgetState extends State<OpenShiftWidget> {
  late OpenShiftModel _model;
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if ((_model.apiResultick?.succeeded ??
                                        true)) {
