...
class _IncomeWidgetState extends State<IncomeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IncomeModel());
                ...
                Column(
                  ...
                  children: [
                    FutureBuilder<ApiCallResponse>(
                      future: NawiriPOSGroup.incomeCall.call(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final listViewIncomeResponse = snapshot.data!;
                        return Builder(
                          builder: (context) {
                            final income =
                                listViewIncomeResponse.jsonBody.toList();
