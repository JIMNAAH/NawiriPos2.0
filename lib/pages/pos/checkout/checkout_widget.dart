                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      setState(() {
                                        FFAppState().cash = double.parse(_model
                              ...
                              Column(
                                ...
                                children: [
                                  FutureBuilder<ApiCallResponse>(
                                    future:
                                        NawiriPOSGroup.getCustomersCall.call(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        ...
                                        options: List<String>.from(
                                            NawiriPOSGroup.getCustomersCall
                                                .customerID(
                      ...
                      children: [
                        FutureBuilder<List<GetCartRow>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final buttonGetCartRowList = snapshot.data!;
                              ...
                              onPressed: () async {
                                if ((_model.userInputTextController.text !=
                                  ...
                                  _model.apiResultcni =
                                    ...
                                    receiptId: '0',
                                    receiptRef: '0',
                                    receiptDate: dateTimeFormat(
                                        'yMd', getCurrentTimestamp),
                                    receiptTime: dateTimeFormat(
                                    ...
                                    receiptDetailsJson: functions.convertToJson(
                                        buttonGetCartRowList.toList()),
                                    shiftId: FFAppState().ShiftD,
                                  );
                                  if ((_model.apiResultcni?.succeeded ??
                                      true)) {
                                    ...
                                    await actions.receiptGenerator(
                                      buttonGetCartRowList.toList(),
                                    );
