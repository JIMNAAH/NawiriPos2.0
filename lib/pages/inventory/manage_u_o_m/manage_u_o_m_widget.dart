...
import 'manage_u_o_m_model.dart';
export 'manage_u_o_m_model.dart';

class ManageUOMWidget extends StatefulWidget {
  const ManageUOMWidget({
    super.key,
  ...
  @override
  State<ManageUOMWidget> createState() => _ManageUOMWidgetState();
}

class _ManageUOMWidgetState extends State<ManageUOMWidget> {
  late ManageUOMModel _model;
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if ((_model.apiResulty7u?.succeeded ??
                                              true)) {
