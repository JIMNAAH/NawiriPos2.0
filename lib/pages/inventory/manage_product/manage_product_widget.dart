...
import 'manage_product_model.dart';
export 'manage_product_model.dart';
...
class ManageProductWidget extends StatefulWidget {
  ...
  @override
  State<ManageProductWidget> createState() => _ManageProductWidgetState();
}

class _ManageProductWidgetState extends State<ManageProductWidget> {
  late ManageProductModel _model;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    future:
                                        NawiriPOSGroup.getcategorysCall.call(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final dropDownGetcategorysResponse =
                                          snapshot.data!;
                                      return FlutterFlowDropDown<String>(
                                        controller: _model
                                                .dropDownValueController1 ??=
                                            FormFieldController<String>(null),
                                        options: NawiriPOSGroup.getcategorysCall
                                            .categoryName(
                                          dropDownGetcategorysResponse.jsonBody,
                                        )!,
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final dropDownGetUomsResponse =
                                          snapshot.data!;
                                      return FlutterFlowDropDown<String>(
                                        controller:
                                            _model.dropDownValueController2 ??=
                                                FormFieldController<String>(
                                          _model.dropDownValue2 ??= widget.uom,
                                        ),
                                        options:
                                            NawiriPOSGroup.getUomsCall.uomID(
                                          dropDownGetUomsResponse.jsonBody,
                                        )!,
                                        onChanged: (val) => setState(
